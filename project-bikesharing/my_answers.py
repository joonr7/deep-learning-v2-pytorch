...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # self.derivative_of_activation_function = lambda x : x*(1-x) # derivative(sigmoid) = sigmoid * (1-sigmoid)
    ...
    def forward_pass_train(self, X):
        ...
        # hidden_outputs = hidden_inputs # No activation # signals from hidden layer 
        hidden_outputs = self.activation_function(hidden_inputs) # Activation
